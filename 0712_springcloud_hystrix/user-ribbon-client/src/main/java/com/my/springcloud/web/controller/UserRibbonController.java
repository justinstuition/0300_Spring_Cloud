...
import com.my.springcloud.web.hystrix.UserRibbonClientHystrixCommand;
...
public class UserRibbonController {
    ...
    public UserRibbonController(RestTemplate restTemplate, LoadBalancerClient loadBalancerClient,
    ...
    public List<User> findAll() {
        ...
        // 每次请求都要创建一个新的实例
        return new UserRibbonClientHystrixCommand(serviceProviderName, restTemplate)
                .execute();
    }
}
